...
class UserTrainerPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\UserTrainer  $userTrainer
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, UserTrainer $userTrainer)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, UserTrainer $userTrainer)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, UserTrainer $userTrainer)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, UserTrainer $userTrainer)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, UserTrainer $userTrainer)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, UserTrainer $userTrainer)
    {
